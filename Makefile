...
ifeq ($(OS_TAG),linux)
	...
	$(CXX) -shared -fPIC -o $(TEST_LIB_DIR)/libmallocwrapper.$(SOEXT) test/native/libs/mallocwrapper.cpp
...
build-test-bins:
	...
	$(CC) -o $(TEST_BIN_DIR)/malloc_wrapper -Isrc test/test/nativemem/malloc_wrapper.c -ldl
