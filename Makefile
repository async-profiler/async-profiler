...
ifeq ($(OS_TAG),linux)
	...
	$(CC) -shared -fPIC -o $(TEST_LIB_DIR)/libmallocwrapper.$(SOEXT) test/native/libs/mallocwrapper.c
...
build-test-bins:
	...
	gcc -o $(TEST_BIN_DIR)/malloc_wrapper -Isrc test/test/nativemem/malloc_wrapper.c -ldl
