...
Latest release (1.8):
 ...
 - Linux x64 (musl): [async-profiler-1.8-linux-x64-musl.tar.gz](https://github.com/jvm-profiling-tools/async-profiler/releases/download/v1.8/async-profiler-1.8-linux-x64-musl.tar.gz)
