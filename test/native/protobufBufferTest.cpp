...
TEST_CASE(Buffer_test_var32_0) {
    ProtobufBuffer* buf = (ProtobufBuffer*)alloca(100);
    buf->reset();
...
TEST_CASE(Buffer_test_repeated_double) {
    ...
    CHECK_EQ((unsigned char)buf->data()[1], 64);
    CHECK_EQ((unsigned char)buf->data()[2], 65);
    CHECK_EQ((unsigned char)buf->data()[3], 12);
    CHECK_EQ((unsigned char)buf->data()[4], 204);
    CHECK_EQ((unsigned char)buf->data()[5], 204);
    CHECK_EQ((unsigned char)buf->data()[6], 204);
    CHECK_EQ((unsigned char)buf->data()[7], 204);
    CHECK_EQ((unsigned char)buf->data()[8], 205);
    CHECK_EQ((unsigned char)buf->data()[9], (2 << 3) | I64);
    CHECK_EQ((unsigned char)buf->data()[10], 64);
    CHECK_EQ((unsigned char)buf->data()[11], 60);
    ...
    CHECK_EQ((unsigned char)buf->data()[16], 51);
    CHECK_EQ((unsigned char)buf->data()[17], 51);
}
