...
public class SeparatedStateFlameGraph {
    public String title = "Separated State Flame Graph";
    ...
    public SeparatedStateFlameGraph(String... args) {
    ...
    private void printFrame(PrintStream out, String title, Frame frame, int level, long x) {
        ...
        out.println("f(" + level + "," + x + "," + frame.total + "," + type + ",'" + title + "'," + frame.getTotalOnCPURatio() + ")");
