...
void ProtoBuffer::fieldFixed64(protobuf_index_t index, u64 n) {
    ...
    _data[_offset++] = (char) n;
    _data[_offset++] = (char) (n >> 8);
    _data[_offset++] = (char) (n >> 16);
    _data[_offset++] = (char) (n >> 24);
    _data[_offset++] = (char) (n >> 32);
    _data[_offset++] = (char) (n >> 40);
    _data[_offset++] = (char) (n >> 48);
    _data[_offset++] = (char) (n >> 56);
}
