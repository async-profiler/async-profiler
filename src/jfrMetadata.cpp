    ...
    *this
        << (element("metadata")
            ...
            << (type("profiler.ProcessSample", T_PROCESS_SAMPLE, "Process Stats Sample")
                ...
                << field("vmSize", T_LONG, "Virtual Memory Size")
                << field("vmRss", T_LONG, "Resident Memory Size")
                << field("rssAnon", T_LONG, "Resident anonymous memory")
                << field("rssFiles", T_LONG, "Resident file mappings")
                << field("rssShmem", T_LONG, "Resident shared Memory")
